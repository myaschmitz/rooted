import { Droplets, Calendar, Scissors, Bug, Sprout, MoreHorizontal } from 'lucide-react-native';
...
export const getCareTypeByType = (type: CareEventType): CareTypeDefinition | undefined => {
  return CARE_TYPES.find((ct) => ct.type === type);
};

export type FertilizerStrength = '1/4' | '1/2' | '1x' | '1.5x' | '2x';

export const FERTILIZER_STRENGTHS: FertilizerStrength[] = ['1/4', '1/2', '1x', '1.5x', '2x'];
